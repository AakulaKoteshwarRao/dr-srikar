...
export function procedureSchema(config, procedure) {
  ...
  return {
    ...
    "cost": {
      ...
      "value":    procedure.cost.price,
      "minValue": procedure.cost.minPrice,
      "maxValue": procedure.cost.maxPrice,
    },
...
export function localBusinessSchema(config, location) {
  ...
  return {
    ...
    "geo": {
      "@type":    "GeoCoordinates",
      "latitude":  clinic.geo.latitude,   // N8: Number from config
      "longitude": clinic.geo.longitude,  // N8: Number from config
    },
