    ...
    <div style={{
      ...
      <div style={{
        ...
        <button onClick={() => setOpen(false)} style={{
          ...
          width: '32px', height: '32px', cursor: 'pointer', fontSize: 'var(--text-lg)',
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem' }}>
          <input type="text" placeholder="Your Name *" value={form.name} onChange={e => set('name', e.target.value)}
            style={{ width: '100%', padding: '0.75rem 1rem', border: '1.5px solid var(--neutral-200)', borderRadius: '10px', fontSize: 'var(--text-base)', outline: 'none', boxSizing: 'border-box' }} />
          ...
          <select value={form.reason} onChange={e => set('reason', e.target.value)}
            style={{ width: '100%', padding: '0.75rem 1rem', border: '1.5px solid var(--neutral-200)', borderRadius: '10px', fontSize: 'var(--text-base)', outline: 'none', background: '#FFFFFF', boxSizing: 'border-box' }}>
          ...
          <textarea placeholder="Notes (optional)" value={form.notes} onChange={e => set('notes', e.target.value)} rows={3}
            style={{ width: '100%', padding: '0.75rem 1rem', border: '1.5px solid var(--neutral-200)', borderRadius: '10px', fontSize: 'var(--text-base)', outline: 'none', resize: 'none', boxSizing: 'border-box' }} />
        </div>
        ...
        <p style={{ textAlign: 'center', fontSize: 'var(--text-sm)', color: 'var(--neutral-400)', marginTop: '0.75rem' }}>
