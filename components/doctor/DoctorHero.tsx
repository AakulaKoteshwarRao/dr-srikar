          ...
          <div className="doc-info">
            ...
            <div className="doc-details">
              <div className="doc-detail-item">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{ width: 18, height: 18, color: 'var(--primary)', flexShrink: 0 }}>
              ...
              <div className="doc-detail-item">
                ...
                <span style={{ color: 'rgba(255,255,255,0.7)', fontSize: 'var(--text-base)' }}>{doctor.languages.join(' &middot; ')}</span>
              </div>
            </div>
