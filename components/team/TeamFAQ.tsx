...
export default function TeamFAQ({ clinic }: { clinic: ClinicInfo }) {
  ...
  const faqs = [
    ...
    { q: 'Are all doctors available every day?', a: `Consulting doctors have specific days and hours. The lead doctor is available ${clinic.hours}. Please check each doctor's schedule or call the clinic for availability.` },
